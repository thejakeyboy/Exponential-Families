...
\sindhu{does a discussion of liquidity fit in here?}
%Also note that if we consider a cost function with a liquidity parameter as in Section \ref{}, 
