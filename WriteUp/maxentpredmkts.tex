...
%
\begin{example}
We consider a finite outcome space $\mX = \{1,2,\ldots,d\}$ and set up a market with an Arrow-Debreu security $\phi_i$ for every outcome $i$: the security pays off 1 if $i$ occurs and 0 otherwise. The log-partition function recovers the classical LMSR cost function~\citep{H07}:
