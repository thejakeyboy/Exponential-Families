...
We see that the equilibrium state is a convex combination of all beliefs and the initial market state, where beliefs are weighted by the agents' risk tolerances (inverse risk aversion).
