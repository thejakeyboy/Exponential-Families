...
One popular form of prediction markets is the market scoring rule~\cite{hanson03}. A market scoring rule considers all trades as a single chronological sequence. Traders earn rewards proportional to the incremental reduction in prediction loss caused by their trades in comparison to the previous trade. In other words, their rewards depend on the change in market probabilities caused by their trade, as well as on the eventual outcome. Thus, each trader has an 
...
We have dual goals in this paper. On the one hand, we highlight a structural similarity between prediction markets and exponential families. We see this as the syntax of our prediction market mechanism. On the other, this formulation has rich semantics as well: it allows for analysis of the evolution of the market under various  models of trader behavior. 

Traders with limited budgets are constrained in how much they influence the market. Their purchases may not reflect their true beliefs. We analyze the market  under these circumstances; we are able to show that traders with good information can expect to profit and their influence over the market state increases over time whereas malicious traders have limited impact on the market.
...
For risk averse traders, we show how a single trader interacts with the market as well as when multiple traders achieve equilibrium. The eventual market state turns out to be a weighted combination of trader beliefs and initial market state; the weights depend on the risk aversion parameter of the individual traders. Trader behavior varies depending on whether they assimilate information as Bayesians or as frequentists.  Interestingly, we show that although these two kinds of traders pick the eventual market state as a convex combination of their private belief and current market state, they do so in dual spaces.
