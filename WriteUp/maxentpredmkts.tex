...
%
As a generalization of this example, the maximum entropy distribution for the $k$-th moment $\phi(x) = x^k$ with respect to the same base measure is the Weibull distribution. Taking its log density leads to the following equivalent scoring rule (after scaling and eliminating unnecessary additive constants):
%
\begin{equation*}
...
EXPONENTIAL EXAMPLE: EFFECTIVE DOMAIN AND COST FUNCTION
GAUSSIAN EXAMPLE
VON MISES EXAMPLE
