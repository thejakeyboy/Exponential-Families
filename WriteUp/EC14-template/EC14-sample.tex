...
\doi{2600057.2600058}% TeXSupport
...
% Title portion
\title{An EC’14 Sample File Only, \underline{N}ote \underline{I}nitial \underline{C}aps to be Used  for the Titles} 
\author{GANG ZHOU
...
\begin{bottomstuff}
This work is supported by the National Science Foundation, undergrant
CNS-0435060, grant CCR-0325197 and grant EN-CS-0329609. See the
Acknowledgements section before REFERENCES.

Author’s addresses: G. Zhou, Computer Science Department, College of
William \& Mary; email: \url{g.zhou@sample.com}; Y. Wu and J.A. Stankovic, CS  Dept, Univ. of
Virginia; email: \{y.wu,ja.stankovic\}@sample.com; T. Yan, Eaton Innovation Center; email: t.yam@sample.com; T. He, Computer Science
Dept., Univ. of Minnesota; email: t.he@sample.com; C. Huang, Google; email: c.huang@google.com; T.F. Abdelzaher, CS
Dept, Univ. of Illinois at Urbana-Champaign; email: tf.abdelzaher@sample.com.
\end{bottomstuff}
